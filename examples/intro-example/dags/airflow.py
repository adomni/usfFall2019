...
import sys
# sys.path.insert(0, '../')
# from script import fetchMaxDaily
from fetchMaxDaily import maxToCsv
import os
cwd = os.getcwd()
print(cwd)
# --------------------------------------------------------------------------------
...
default_args = {
    ...
    'start_date': datetime(2019,10,3,22,00),
    'email': ['leeth7830@gmail.com'],
...
dag = DAG(
    'airflow_dag', default_args=default_args,
...
maxToCsv = PythonOperator(
    task_id='maxToCsv',
    python_callable=maxToCsv,
    dag=dag)
#t2.set_upstream(t1)
#t3.set_upstream(t1)
